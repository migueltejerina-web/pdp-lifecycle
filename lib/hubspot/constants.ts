...
/** Set when the investor uploads a signed PoA file (manual upload). */
export const HUBSPOT_POA_STATUS_EXECUTED =
...
/** Deal: tasación document (file upload). */
export const HUBSPOT_DEAL_VALUATION_DOC_PROPERTY = "valuation_doc";

export const HUBSPOT_DEAL_TECH_VALUATION_DOC_URLS_PROPERTY = "tech__valuation_doc_urls";
...
/** Deal: comprobante REAF (honorarios agencia) — file upload. */
export const HUBSPOT_DEAL_REAL_ESTATE_AGENT_FEE_FILE_PROPERTY = "real_estate_agent_fee_file";

export const HUBSPOT_DEAL_PAYMENT_STATUS_REAF_PROPERTY = "payment_status__reaf";

export const HUBSPOT_DEAL_REAF_RECEIPT_PROPERTIES = [
...
/** Deal: OPS financing requirement — hides tasación / FEIN when "Not Required". */
export const HUBSPOT_DEAL_FINANCING_PROPERTY = "financing";

export const HUBSPOT_FINANCING_NOT_REQUIRED = "Not Required";
